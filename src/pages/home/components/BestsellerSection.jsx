  ...
  const products = [
    {
      ...
      category: 'tshirt',
      type: 'regular',
      image: 'https://readdy.ai/api/search-image?query=Black%20cotton%20t-shirt%20on%20clean%20white%20background%2C%20essential%20basic%20design%2C%20premium%20fabric%20quality%2C%20classic%20regular%20fit%2C%20minimalist%20style%2C%20everyday%20casual%20wear%2C%20high%20quality%20product%20photography%2C%20soft%20natural%20lighting&width=300&height=400&seq=black-tee-001&orientation=portrait',
      badge: 'Bestseller'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      price: 59.99,
      category: 'hoodie',
      image: 'https://readdy.ai/api/search-image?query=Gray%20cotton%20hoodie%20on%20clean%20white%20background%2C%20classic%20comfortable%20fit%2C%20premium%20fabric%20texture%2C%20modern%20streetwear%20style%2C%20cozy%20warm%20clothing%2C%20urban%20fashion%2C%20soft%20natural%20lighting%2C%20professional%20photography&width=300&height=400&seq=gray-hoodie-001&orientation=portrait',
      badge: 'Popular'
    },
    {
      id: 4,
    ...
    },
    {
      ...
      category: 'hoodie',
      type: 'oversized',
      image: 'https://readdy.ai/api/search-image?query=Black%20oversized%20hoodie%20on%20clean%20white%20background%2C%20relaxed%20comfortable%20fit%2C%20premium%20cotton%20fabric%2C%20street%20style%20fashion%2C%20modern%20urban%20wear%2C%20cozy%20warm%20clothing%2C%20professional%20product%20photography&width=300&height=400&seq=black-hoodie-001&orientation=portrait',
      badge: 'Limited'
    },
    {
      id: 6,
      ...
      category: 'tshirt',
      type: 'oversized',
      image: 'https://readdy.ai/api/search-image?query=Cream%20colored%20oversized%20cotton%20t-shirt%20on%20clean%20background%2C%20soft%20neutral%20tone%2C%20relaxed%20loose%20fit%2C%20premium%20quality%20fabric%2C%20modern%20casual%20style%2C%20comfortable%20streetwear%2C%20professional%20photography&width=300&height=400&seq=cream-over-001&orientation=portrait'
    }
  ];
    ...
    <section className="py-12 sm:py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">Bestsellers</h2>
        ...
        <div className="relative px-8 sm:px-12">
          ...
          {totalSlides > 1 && (
            <>
              <button
                onClick={prevSlide}
                className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full p-2 sm:p-3 shadow-lg hover:bg-gray-100 transition-colors cursor-pointer w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center"
              ...
              <button
                onClick={nextSlide}
                className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full p-2 sm:p-3 shadow-lg hover:bg-gray-100 transition-colors cursor-pointer w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center"
          ...
          <div className="overflow-hidden">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8" data-product-shop>
              ...
              {Array.from({ length: totalSlides }).map((_, index) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all cursor-pointer ${
                    currentSlide === index ? 'bg-black w-6 sm:w-8' : 'bg-gray-300 w-2'
                  }`}

...
const heroSlides = [
  {
    ...
    subtitle: "Redefined",
    description:
      "Discover our premium collection of t-shirts and hoodies designed for the modern urban lifestyle. Quality meets comfort in every stitch.",
    backgroundImage:
  ...
  },
  {
    ...
    subtitle: "T-Shirts",
    description:
      "Crafted from the finest materials, our t-shirts offer unmatched comfort and style. Perfect for everyday wear or special occasions.",
    backgroundImage:
  ...
  },
  {
    ...
    subtitle: "Hoodies",
    description:
      "Stay warm and stylish with our collection of premium hoodies. Designed for comfort without compromising on style.",
    backgroundImage:
...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-[650px] sm:h-[700px] rounded-b-3xl lg:min-h-screen overflow-hidden">
      {/* Slides */}
